...
export class Luv2shopService {
  ...
  private countriesUrl: string = "http://localhost:8083/api/countries";
  private statesUrl: string = `http://localhost:8083/api/states`;
  ...
  getCreditCardYears(startYear: number, endYear: number): Observable<number[]> {
    let data: number[] = [];
